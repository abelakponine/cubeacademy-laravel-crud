...
<body>
    <div class="d-flex h-100">
        <div class="container w-75 mx-auto">
            <h1 class="py-3">Create New Blog Post</h1>
            <form id="postForm">
                @csrf
                @method('post')
                <input type="text" id="title" class="title-input" name="title" placeholder="Post Title">
        ...
        <div id="side-bar" class="pt-5 w-25 mx-5">
            <ul class="m-0 px-0" style="width:100%;height:100%;overflow:auto;">
                <?php
                    ...
                    echo count($all_posts) > 0 ? '' : '<h2>No post found.</h2>';
